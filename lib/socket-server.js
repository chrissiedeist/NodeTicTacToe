...
var enterPlayer = function(socket, io){
  ...
  else if(guestNumber ===3){ ready = true, message = "Begin play at any time!" }
  else { ready = false, message = "Uh-oh, looks like this game is open in more than two browsers! Please close navigate back to the original two browsers, or restart the session and try again."
  }
